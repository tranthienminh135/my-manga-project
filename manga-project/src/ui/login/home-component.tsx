...
export default function HomeComponent() {
    ...
    const [userInfo, setUserInfo] = useState<UserGoogleInfo>(initialUserGoogleInfoState);
    ...
    const handleGoogleLogout = () => {
        ...
        dispatch(userActions.setUserInfo(initialUserGoogleInfoState));
        setUserInfo(initialUserGoogleInfoState);
